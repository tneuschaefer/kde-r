...
This method takes the amount n of samples you wanto to simulate, a density you want to take samples from (sample_density), a distribution and its density and a numeric positive scalar M satisfying sample_density(x) <= M * density(x) for all x as an input and returns a sample with n entries.
